...
import org.example.web_lap.security.Endpoints;
import org.example.web_lap.security.JwtFilter;
...
//                        .requestMatchers(HttpMethod.POST, Endpoints.PRIVATE_ADMIN_POST).hasRole("ADMIN")
//                        .requestMatchers(HttpMethod.DELETE , Endpoints.PRIVATE_ADMIN_DELETE).hasRole("ADMIN")
//                        .requestMatchers(HttpMethod.PUT , Endpoints.PRIVATE_ADMIN_PUT).hasRole("ADMIN")
        );
        // Cấu hình cors
        http.cors(cors -> {
